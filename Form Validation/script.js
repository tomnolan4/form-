...
if (errorMessages.length > 0 ) { // if error messages greater thn 0 - preveent the default
...
function clearErrors() {
    ...
    // Also, make sure you remove the show class to the errors container
        // errorsList.innerHTML ="" //setting this to an empty string stops the error message repeating over and over

      
        //there is another way to do the above but we only did it to practice while loops
